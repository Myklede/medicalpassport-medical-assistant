...
run('Portal, IPS, medication and wound unit tests', process.execPath, ['--test', 'tests/portal.test.ts', 'tests/ips-export.test.ts', 'tests/medication-exchange.test.ts', 'tests/wound-safety.test.ts', 'tests/wound-api.test.ts', 'tests/wound-sessions-api.test.ts', 'tests/wound-presentation.test.ts', 'tests/wound-schema.test.ts']);
